...
- **Teaser** (`card-text`, inline **`marginBottom: '0'`**): **"A downloadable guide for owners running one clinic that bills insurance and sells advanced care without the two halves fighting."** *(V35 dropped the opening "short"; V36 dropped the trailing sentence "Name what your practice actually sells, so your whole team can say it." as redundant with the modal, which says "say it in one sentence your whole team can repeat.")*
