# FranklinAI — Project Instructions (Version 50, Current)
...
> **Version 50 updates:** **GlowPT is now ONE sentence, on all four public surfaces.** David chose a single line and put it everywhere, replacing three drifting variants of the same idea: **"The GlowPT app keeps patients engaged between visits, so more plans of care get completed and the clinic stays full."** It now reads identically on **glowpt.app's hero**, **glowpt.app's More Info modal**, **this site's Available card teaser**, and **this site's GlowPT modal description**. **Two changes shipped to `App.jsx`, both inside the GlowPT surfaces.** **(1) The card teaser was replaced.** The V44 string ("An app for physical therapy patients to stay engaged between visits, with zero work for your therapists.") is retired. **(2) The modal description lost its problem-setup sentence.** "Patients walk out doing great, then drift off before their plan of care is done." is deleted; the V46 description is retired and the paragraph is now the single sentence alone. **(3) Two things the old copy carried are deliberately given up.** "Zero work for your therapists" survives only as **modal bullet 6**, and **the teaser no longer names the niche** — which retires that clause of *Where the niche is named and where it is not*. The **headline still names the practice**, so the site has not stopped being specific. **(4) The repetition is the point, and it was argued before it shipped.** David was told the hero and the modal on glowpt.app would then say nearly the same thing twice in a row. He chose it anyway, on consistency and the teaching value of repetition. **Do not "fix" the duplication on either site.** **(5) `App.jsx` now measures 669 lines** on the pushed file, down from 670, because the description paragraph lost a line. **(6) A cross-repo dependency is recorded:** the ghost button label here must keep matching glowpt.app's own primary button. Sections updated: title, header summary (V49 folded into a carried-forward paragraph, V48/V47/V46/V45/V44/V43/V42/V41/V40 kept), Business, Available/GlowPT Modal, Flagship Example, GlowPT, Locked Inline Styles, Change History.
...
> **Everything else from Version 44 remains in force:** the three V44 copy records (the newsletter description's tail reads **"what's working and not working in your practice, and what to do about it"**; the e-book teaser opens **"A downloadable guide"**; **the V44 GlowPT teaser is RETIRED by V50** and now reads **"The GlowPT app keeps patients engaged between visits, so more plans of care get completed and the clinic stays full."**), and the correction that the GlowPT modal's **EMR bullet sits seventh, not eighth**. *(V49 closes V44's open item on bullet 8's word "flags": it is confirmed live in the product.)*
>
...
>
> **⚠️ CHANGED IN V50: the GlowPT teaser no longer names the niche.** It used to, as "physical therapy patients", and that clause is retired. The teaser now carries the one shared GlowPT sentence instead, chosen for cross-site consistency. **The headline still names the practice, so the front door is unchanged** — but if the headline is ever rewritten, this is now the only place on the card stack where the niche appears. Do not let both go.
...
- **Teaser** (`card-text`, `:last-of-type`): **"The GlowPT app keeps patients engaged between visits, so more plans of care get completed and the clinic stays full."** *(V50. **Identical to the modal description below and to glowpt.app's hero** — one sentence, every surface, by David's explicit choice. Replaces the V44 string, which named the niche and closed on "with zero work for your therapists"; both of those are given up here and the zero-work claim survives as **modal bullet 6**.)*
...
- **Description paragraph (V50):** **"The GlowPT app keeps patients engaged between visits, so more plans of care get completed and the clinic stays full."** *(One sentence. The V46 setup sentence "Patients walk out doing great, then drift off before their plan of care is done." was **deleted in V50** and is gone from glowpt.app too. **Identical to the card teaser above and to glowpt.app's hero and More Info modal** — four surfaces, one line. **Do not reintroduce the setup sentence on one site only.**)*
