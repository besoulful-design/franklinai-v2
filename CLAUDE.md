...
| Nav "Solutions, LLC" | Inter | 700 | clamp(25.6px, 2.72vw, 31.5px), #60a5fa, nudged translateX(-2px). **V29: Inter 700 (was Playfair Display 400) to match the CTA-button font, bolder.** |
| Footer name | Playfair Display | 700 | 32px, blue with "AI" white |
| Footer "Solutions, LLC" | Inter | 700 | 20px, #60a5fa, nudged translateX(-2px). **V29: Inter 700 (was Playfair Display 400).** |
...
- Name: `clamp(40.95px, 4.35vw, 50.4px)`, blue #60a5fa with "AI" white #ffffff; "Solutions, LLC": **Inter 700** (V29; was Playfair 400), `clamp(25.6px, 2.72vw, 31.5px)`, blue #60a5fa, with `transform: 'translateX(-2px)'`
...
2. Solutions, LLC — **Inter 700** (V29; was Playfair 400), **20px**, **blue #60a5fa**, marginTop 3px (in the home link), `transform: 'translateX(-2px)'`
...
| Nav "Solutions, LLC" `<span>` | fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: 'clamp(25.6px, 2.72vw, 31.5px)', color: '#60a5fa', lineHeight: '1', marginTop: '3px', transform: 'translateX(-2px)' (text "Solutions, LLC"). **V29: fontFamily/fontWeight added inline (Inter 700) to override the Playfair the `.site-nav__city` class was supplying.** |
...
| Footer "Solutions, LLC" `<span>` | fontFamily: Inter, fontWeight: 700, fontSize: '20px', letterSpacing: '0.02em', color: '#60a5fa', marginTop: '3px', transform: 'translateX(-2px)' (text "Solutions, LLC"). **V29: was Playfair Display 400.** |
