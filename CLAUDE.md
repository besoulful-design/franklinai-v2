...
| Nav "Solutions, LLC" | Inter | 800 | clamp(25.6px, 2.72vw, 31.5px), #60a5fa, nudged translateX(-2px). **V29: Inter (was Playfair Display) to match the CTA-button font. V30: weight 700 → 800.** |
| Footer name | Playfair Display | 700 | 32px, blue with "AI" white |
| Footer "Solutions, LLC" | Inter | 800 | 20px, #60a5fa, nudged translateX(-2px). **V29: Inter (was Playfair Display). V30: weight 700 → 800, synced with the nav subline.** |
...
- Name: `clamp(40.95px, 4.35vw, 50.4px)`, blue #60a5fa with "AI" white #ffffff; "Solutions, LLC": **Inter 800** (V29 Inter, V30 weight 700 → 800), `clamp(25.6px, 2.72vw, 31.5px)`, blue #60a5fa, with `transform: 'translateX(-2px)'`
...
2. Solutions, LLC — **Inter 800** (V29 Inter, V30 weight 700 → 800, synced with nav), **20px**, **blue #60a5fa**, marginTop 3px (in the home link), `transform: 'translateX(-2px)'`
...
| Nav "Solutions, LLC" `<span>` | fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: 'clamp(25.6px, 2.72vw, 31.5px)', color: '#60a5fa', lineHeight: '1', marginTop: '3px', transform: 'translateX(-2px)' (text "Solutions, LLC"). **V29: fontFamily/fontWeight added inline to override the Playfair the `.site-nav__city` class was supplying. V30: fontWeight 700 → 800.** |
...
| Footer "Solutions, LLC" `<span>` | fontFamily: Inter, fontWeight: 800, fontSize: '20px', letterSpacing: '0.02em', color: '#60a5fa', marginTop: '3px', transform: 'translateX(-2px)' (text "Solutions, LLC"). **V29: was Playfair Display 400. V30: weight 700 → 800, synced with the nav subline.** |
